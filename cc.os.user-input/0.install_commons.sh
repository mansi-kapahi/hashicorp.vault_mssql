...
PKGS="locales locales-all bc policykit-1 unzip ca-certificates curl  gnupg  lsb-release software-properties-common htop screen jq build-essential libssh-dev" ;
